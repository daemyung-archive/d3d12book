//***************************************************************************************
// BlendingApp.cpp by Frank Luna (C) 2015 All Rights Reserved.
//
...
void BlendingApp::BuildLandGeometry()
{
...
void BlendingApp::BuildWavesGeometry()
{
...
void BlendingApp::BuildBoxGeometry()
{
    GeometryGenerator geoGen;
...
float BlendingApp::GetHillsHeight(float x, float z) const
{
    return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 BlendingApp::GetHillsNormal(float x, float z) const
{
    // n = (-df/dx, 1, -df/dz)
    XMFLOAT3 n(
